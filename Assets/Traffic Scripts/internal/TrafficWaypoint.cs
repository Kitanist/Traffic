...
namespace Gley.TrafficSystem.Internal
{
    ...
    public class TrafficWaypoint : Waypoint
    {
        ...
        public int[] tempOtherLanes;
        public int[] GiveWayList => _giveWayList;
        public VehicleTypes[] AllowedVehicles
        {
            get
            {
                return _allowedVehicles;
            }
            set
            {
                _allowedVehicles = value;
            }
        }
        public int[] OtherLanes
        {
            get
            {
                return _otherLanes;
        ...
        public TrafficWaypoint(string name, int listIndex, Vector3 position, List<VehicleTypes> allowedVehicles, int[] neighbors, int[] prev,bool TempDis , int[] otherLanes, int maxSpeed, bool giveWay,
            bool complexGiveWay, bool zipperGiveWay, bool triggerEvent, float laneWidth, string eventData, int[] giveWayList)
            : base(name, listIndex, position, neighbors, prev,TempDis)
        {
            _maxSpeed = maxSpeed;
            _giveWay = giveWay;
