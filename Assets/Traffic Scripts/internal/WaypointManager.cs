...
namespace Gley.TrafficSystem.Internal
{
    ...
    internal class WaypointManager : IDestroyable
    {
        ...
        public readonly TrafficWaypointsDataHandler _trafficWaypointsDataHandler;
        ...
        /// </summary>
        /// <param name="waypointIndex"></param>
        internal void AddDisabledWaypoint(int waypointIndex,bool isEnable)
        {
            _disabledWaypoints.Add(waypointIndex);
            _trafficWaypointsDataHandler.SetTemperaryDisabledValue(waypointIndex, isEnable); 
        }
        ...
        /// <returns></returns>
        public bool IsTargetFree(int waypointIndex, float distance, int initialWaypointIndex, int currentCarIndex, ref int incomingCarIndex)
        {
#if UNITY_EDITOR
            if (_debugGiveWay)
            {
