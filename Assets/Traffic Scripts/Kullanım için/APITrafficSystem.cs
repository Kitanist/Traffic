...
namespace Gley.TrafficSystem
{
    public static class API
    {
        ...
        {
#if GLEY_TRAFFIC_SYSTEM
            TrafficManager.Instance.RemoveVehicle(vehicle,true);
#endif
        }
        public static void DisableSingleWaypoint(int index,bool isdisable)
        {
            TrafficManager.Instance.DensityManager._waypointManager.AddDisabledWaypoint(index, isdisable);
        }
        public static void RemoveAllVehicles(List<GameObject> Cars)
        { 
            TrafficManager.Instance.RemoveVehicle(Cars);
        }
        /// <summary>
        /// Remove a specific vehicle from scene
        /// </summary>
        ...
        {
#if GLEY_TRAFFIC_SYSTEM
            TrafficManager.Instance.RemoveVehicle(vehicleIndex, true,false);
#endif
        }


        public static void RemoveAndAddVehicleOnCamChanged()
        {
            TrafficManager.Instance.ChangeCamAndRemoveCarsForFatihBrother();
        }
        ...
        public static int GetClosestWaypoint(Vector3 position)
        {
#if GLEY_TRAFFIC_SYSTEM
