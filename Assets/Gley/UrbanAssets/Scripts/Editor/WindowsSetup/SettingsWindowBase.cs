...
namespace Gley.UrbanSystem.Editor
{
    public abstract class SettingsWindowBase : EditorWindow
    {
        ...
        public SetupWindowBase _activeSetupWindow;
        ...
        public void Init(SettingsWindowBase window, Type defaultWindowType, WindowProperties[] allWindowsProperties, AllSettingsWindows allSettingsWindows)
        {
